...
class ActorAdapter(private val autorsList: List<Actor>) : RecyclerView.Adapter<ActorAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnCreateContextMenuListener {
        ...
        init {
            nombres = view.findViewById(R.id.txt_1) as TextView
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val actor = autorsList[position]
        holder.nombres.text = actor.nombres
